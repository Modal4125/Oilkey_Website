...
export interface ProductsCopy {
  ...
  /**
   * Line under the intro pointing to the catalogue for each brand, split
   * around the two link labels: [before, F@ctory Express, middle, Catalogue, after].
   */
...
export const products: Record<Lang, ProductsCopy> = {
  ...
  en: {
    ...
    brandGuide: [
      'For OKS products, click “',
      'F@ctory Express',
      '”; for Oilkey and BANTLEON products, click “',
      'Catalogue',
      '”.',
    ],
    categories: [
