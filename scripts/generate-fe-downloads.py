...
META = {
    "ja": {
        ...
        "company": "オイルキー株式会社",
        "contact": "TEL 072-284-1711 ／ FAX 072-298-7790",
        "disclaimer": "Eプライスはご注文数量が1個の場合の価格（円）です。価格・納期は予告なく変更される場合があります。",
    ...
    "en": {
        ...
        "contact": "TEL +81-72-284-1711 / FAX +81-72-298-7790",
        "disclaimer": "The E-price is the unit price (JPY) for an order of one. Prices and lead times are subject to change without notice.",
